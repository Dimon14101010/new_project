...
function vcardApi($resource) {
    ...
    let vcardData = {
        ...
        vcardTips : $resource('https://api.foursquare.com/v2/tips/add/?venueId=:vId&text=:text&v=20170725&access_token=JMWWTU2AEH1JHAXCYBFO5HAFDR11H1F3GSUNAMNKDGZYC3MZ',{vId :'@vId',text:'@text'})
