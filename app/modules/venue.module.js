...
function venueApi($resource,$location,$state) {
    ...
    let venueData = {
        ...
        instaPhotos : $resource('https://api.instagram.com/v1/locations/search?lat=:lat&lng=:lng&access_token=5803259975.e029fea.18256d8c19cf4b0e8dcffb712a875522',{lat:"@lat",lng:"@lng"}),
        testData : tokenCtrl($location,$state)
    };console.log('testApi',venueData.testData[1]);console.log('testVENUE',venueData.instaPhotos)
